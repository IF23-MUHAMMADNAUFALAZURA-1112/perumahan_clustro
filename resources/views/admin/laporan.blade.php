                    ...
                    <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md text-sm sm:text-base">
                        <thead class="bg-gray-100 text-gray-600">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left">Tipe Laporan</th>
                                <th class="px-4 py-3 text-left">Isi Laporan</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse($laporans as $laporan)
                                <tr class="border-t border-gray-200">
                                    ...
                                    <td class="px-4 py-3 capitalize text-gray-700">{{ $laporan->tipe }}</td>
                                    <td class="px-4 py-3 text-gray-700">{{ $laporan->isi_laporan }}</td>
                                </tr>
                            @empty
                                <tr>
